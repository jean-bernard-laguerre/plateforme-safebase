...
--
-- Host: localhost    Database: silver-micro
-- ------------------------------------------------------
...
CREATE TABLE `responsables` (
  `id` int NOT NULL AUTO_INCREMENT,
  `role` enum('responsable','patron') COLLATE utf8mb4_general_ci NOT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  `UserId` int DEFAULT NULL,
  `RestaurantId` int DEFAULT NULL,
...
--
-- Dumping routines for database 'silver-micro'
--
...
-- Dump completed on 2024-09-04 10:47:45
